    ...
    <div class="py-4">
        <div class="app-shell-form">
            ...
            <div class="bg-white border rounded-md p-4">
                <div class="text-sm text-gray-700 mb-2">Upload Excel (.xlsx or .xls) with the following columns:</div>
                ...
                <form method="POST" action="{{ route('services.bulk-upload.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="file" accept=".xlsx,.xls,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" class="border-gray-300 rounded-md w-full">
